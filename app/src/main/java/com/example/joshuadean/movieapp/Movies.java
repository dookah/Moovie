...
public class Movies {
    ...
    //I could read the JSON in with volley as JSONObject but no need to as alot of the data i want to just display as text
    ...
    public List<ArrayData> getRatings() {
        return Ratings;
    }

    public void setRatings(List<ArrayData> ratings) {
        Ratings = ratings;
    }
